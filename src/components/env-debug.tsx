      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-1 gap-2 text-xs">
          ...
          <div className="flex justify-between items-center">
            ...
            <Badge
              variant={env.NODE_ENV === "production" ? "default" : "secondary"}
              className="text-xs"
            >
              {env.NODE_ENV}
            </Badge>
          ...
          <div className="flex justify-between items-center">
            ...
            <Badge
              variant={env.DEBUG === "true" ? "default" : "secondary"}
              className="text-xs"
            >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <Badge
                variant={env.SERVER_TOKEN ? "default" : "destructive"}
                className="text-xs"
              >
          ...
          {showToken && env.SERVER_TOKEN && (
            <div className="col-span-full">
              ...
              <div className="bg-secondary/50 p-2 rounded text-xs break-all font-mono">
                {env.SERVER_TOKEN.substring(0, 25)}...
                {env.SERVER_TOKEN.substring(env.SERVER_TOKEN.length - 10)}
              </div>
            </div>
          )}
        </div>
