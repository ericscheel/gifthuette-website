            ...
            <CardContent className="p-8 space-y-8">
              <section>
                ...
                <div className="bg-secondary/30 p-6 rounded-lg">
                  <p className="mb-2">
                    <strong>Gifthütte Hardy Benkovich</strong>
                  </p>
                  <p className="mb-2">Hardy Benkovich</p>
                  <p className="mb-2">Am Glashofkamp 20A</p>
                  <p className="mb-4">25358 Horst (Holstein)</p>
              ...
              <section>
                ...
                <div className="bg-secondary/30 p-4 rounded-lg">
                  <p>
                    <strong>Wird Nachgetragen</strong>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-secondary/30 p-4 rounded-lg">
                  <p>
                    <strong>Mobile Gastronomie / Schausteller</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mt-2">
                    Gewerbeanmeldung bei der Stadt Horst (Holstein)
                  </p>
                </div>
              </section>
