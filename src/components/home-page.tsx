...
export function HomePage({ setCurrentPage }: HomePageProps) {
  ...
  const { data: currentLocation, loading: locationLoading } =
    useCurrentLocation();
  const { data: instagramFeed, loading: instagramLoading } = useInstagramFeed();

  // Newsletter subscription
  const { mutate: subscribeNewsletter, loading: subscribing } =
    useApiMutation();
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    if (result) {
      toast.success(
        "Newsletter-Anmeldung erfolgreich! Bitte bestätigen Sie Ihre E-Mail."
      );
      setNewsletterEmail("");
    } else {
      toast.error(
        "Fehler bei der Newsletter-Anmeldung. Bitte versuchen Sie es erneut."
      );
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Entdecken Sie unsere beliebtesten und einzigartigsten
              Cocktail-Kreationen
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-lg text-muted-foreground">
              <p>
                Was als verrückte Idee begann, ist heute eine der
                einzigartigsten mobilen Bars in der Region. Die Gifthütte
                vereint das rustikale Flair eines alten Pubs mit der Kreativität
                moderner Mixologie.
              </p>
              <p>
                Unsere mobile Bar wandert von Event zu Event und bringt dabei
                eine geheimnisvolle Atmosphäre mit. Jeder Cocktail ist eine
                kleine Alchemie, jede Zutat wird sorgfältig ausgewählt.
              </p>
              <p>
                Das charakteristische grüne Logo mit dem tropfenden "Gift" steht
                für unsere Leidenschaft, außergewöhnliche Getränke zu kreieren,
          ...
          >
            <div className="aspect-square rounded-lg overflow-hidden mystical-glow relative">
              <ImageWithFallback
                src="https://i.imgur.com/b5gJZyS.jpeg"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {instagramLoading ? (
                  ...
                  <Card className="overflow-hidden mystical-card wood-texture border-primary/20 mystical-glow">
                    <div className="aspect-square">
                      <ImageWithFallback
                        src={
                          post.image ||
                          post.media_url ||
                          "https://i.imgur.com/b5gJZyS.jpeg"
                        }
                    ...
                    <CardContent className="p-4">
                      <p className="text-sm mb-2">
                        {post.caption || post.text || "Neue Kreation! 🧪✨"}
                      </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  image: "https://i.imgur.com/b5gJZyS.jpeg",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {locationLoading ? (
            ...
            >
              <Card className="p-8 text-center mystical-card wood-texture border-primary/30">
                <p className="text-xl text-muted-foreground">
                  Zur Zeit sind wir nicht vor Ort. Schauen Sie bald wieder
                  vorbei oder kontaktieren Sie uns für Events!
                </p>
                <Button
                  className="mt-4"
                  onClick={() => setCurrentPage("contact")}
          ...
          >
            <Card className="p-12 mystical-card wood-texture border-primary/20 mystical-glow relative overflow-hidden">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Melden Sie sich für unseren Newsletter an und gewinnen Sie Tolle
                Gutscheine!
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                Keine Sorge, wir spammen nicht! Nur die besten Updates und
                Gewinnchancen.
              </p>
            </Card>
          </motion.div>
