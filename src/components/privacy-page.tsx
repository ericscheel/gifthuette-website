            ...
            <CardContent className="p-8 space-y-8">
              <section>
                ...
                <div className="bg-secondary/30 p-4 rounded-lg">
                  <p>
                    <strong>Gifthütte Hary Benkovich</strong>
                  </p>
                  <p>Hardy Benkovich</p>
                  <p>Am Glashofkamp 20A</p>
                  <p>25358 Horst (Holstein) </p>
                  <p>E-Mail: info@gifthuette.de</p>
                  <p>Telefon: +49 (0) 1517 0303784</p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Beim Aufruf unserer Website werden durch den auf Ihrem
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Auf unserer Website ist ein Kontaktformular vorhanden, welches
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  abonnieren, mit dem wir Sie über unsere aktuellen Events, neue
                  Getränke und Gewinnspiele informieren.
                </p>
                <p className="text-muted-foreground mb-4">
                  Für die Anmeldung verwenden wir das sog.
                  Double-Opt-in-Verfahren. Das heißt, dass wir Ihnen nach Ihrer
                  Anmeldung eine E-Mail an die angegebene E-Mail-Adresse senden,
                  in welcher wir Sie um Bestätigung bitten.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  für die Erfüllung der verfolgten Zwecke erforderlich ist oder
                  sofern dies durch gesetzliche Aufbewahrungsfristen
                  vorgeschrieben ist.
                </p>
              </section>
